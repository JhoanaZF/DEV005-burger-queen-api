...
describe("POST /orders", () => {
    it("should fail with 401 when no auth", () => fetch("/orders", { method: "POST" }).then((resp) => expect(resp.status).toBe(401)));

    it("should fail with 400 when bad props", () => fetchAsTestUser("/orders", { method: "POST", body: {} }).then((resp) => expect(resp.status).toBe(400)));
...
describe("GET /orders", () => {
    it("should fail with 401 when no auth", () => fetch("/orders").then((resp) => expect(resp.status).toBe(401)));
...
describe("GET /orders/:orderId", () => {
    it("should fail with 401 when no auth", () => fetch("/orders/xxx").then((resp) => expect(resp.status).toBe(401)));

    it("should fail with 404 when admin and not found", () => fetchAsAdmin("/orders/xxx").then((resp) => expect(resp.status).toBe(404)));
...
describe("PUT /orders/:orderId", () => {
    it("should fail with 401 when no auth", () => fetch("/orders/xxx", { method: "PUT" }).then((resp) => expect(resp.status).toBe(401)));
...
describe("DELETE /orders/:orderId", () => {
    it("should fail with 401 when no auth", () => fetch("/orders/xxx", { method: "DELETE" }).then((resp) => expect(resp.status).toBe(401)));

    it("should fail with 404 when not found", () => fetchAsAdmin("/orders/xxx", { method: "DELETE" }).then((resp) => expect(resp.status).toBe(404)));
    ...
    it("should delete other order as admin", () =>
        Promise.all([
            ...
            .then(({ _id }) => fetchAsAdmin(`/orders/${_id}`, { method: "DELETE" }).then((resp) => ({ resp, _id })))
            .then(({ resp, _id }) => {
                expect(resp.status).toBe(200);
